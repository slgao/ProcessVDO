...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.img_save_path, 1, 2, 1, 1)
        ...
        self.checkBox_multifolder = QtGui.QCheckBox(self.gridLayoutWidget_3)
        self.checkBox_multifolder.setObjectName(_fromUtf8("checkBox_multifolder"))
        self.gridLayout_4.addWidget(self.checkBox_multifolder, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_multifolder.setText(_translate("Dialog", "multi_folder(run_day)", None))
